...
class MaskDecoder(nn.Module):
    ...
    def forward(
        ...
        """
        masks, iou_pred, connectMask_2 = self.predict_masks(
        ...
        # Prepare output
        return masks, iou_pred, connectMask_2
    ...
    def predict_masks(
        ...
        #----------------- the second connectMask --------------------
        directional_2 = self.channel_mapping(upscaled_embedding)
        mapped_2 = F.interpolate(directional_2, (256, 256), mode='bilinear', align_corners=True)
        connectMask_2 = self.direc_reencode(mapped_2)
