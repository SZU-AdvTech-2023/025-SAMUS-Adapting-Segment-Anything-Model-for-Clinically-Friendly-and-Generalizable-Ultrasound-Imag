...
class connect_loss(nn.Module):
    ...
    def edge_loss(self,vote_out,edge):
        ...
        # minloss = F.binary_cross_entropy_with_logits(pred_mask_min, torch.full_like(pred_mask_min, 0))
    ...
    def single_class_forward(self, c_map, con_target):
        #######
        ...
        pred,bicon_map = Bilateral_voting(class_pred,hori_translation,verti_translation)  # hori_translation 水平平移矩阵；verti_translation 垂直平移矩阵
        ...
        loss =  conn_l + edge_l + 0.2* bicon_l #+ bce_loss# +loss_out_dice# +sum_l # + edge_l+loss_out_dice
